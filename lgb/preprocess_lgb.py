...
def add_history(dtrain, dtest):
    ...
    return dtrain.fillna(-1), dtest.fillna(-1)
...
def add_binning(df):
    ...
    df['shop_delivery_bin'] = binning(df['shop_score_delivery'], [0.95, 0.96, 0.97, 0.975, 0.98, 0.99])
...
def data_split():
    ...
    test1 = test01.sample(frac=0.3, random_state=13)
    test2 = test01.sample(frac=0.3, random_state=1337)
    test3 = test02.sample(frac=0.3, random_state=13)
    test4 = test02.sample(frac=0.3, random_state=1337)
