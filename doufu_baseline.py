...
for i,feat in enumerate(['category_0', 'category_1', 'category_2', 'property_0']):
    ...
    if i == 0:
        ...
        # X_train, X_test, X_val = np.concatenate([X_train, x_train], axis=1), np.concatenate([X_test, x_test], axis=1), np.concatenate([X_val, x_val], axis=1)

# X_train = train[feat_set]
# X_val = val[feat_set]
# X_test = test_a[feat_set]
